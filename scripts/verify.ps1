...
dotnet build $project -c Release --no-restore -p:Version=0.0.0 -p:OutputPath=$stableOutput
...
dotnet build $project -c Release --no-restore -p:GillionsTestBuild=true -p:Version=0.0.0 -p:OutputPath=$testingOutput
